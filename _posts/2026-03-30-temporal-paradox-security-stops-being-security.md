...
In *Replacing Howey with CLARITY: Resolving Securities Regulation's Temporal Paradox*, Seth C. Oranburg identifies a structural flaw at the center of American securities law and argues that Congress has now fixed it. The flaw is what he calls the "Temporal Paradox": blockchain-based assets can transform their legal status over time, maturing from securities into something resembling commodities as their networks decentralize. The *Howey* test assumes asset classification is fixed and permanent. It provides no framework for assets whose legal identity evolves.
...
The consequences of this gap are not theoretical. Oranburg traces how two federal courts, applying the same *Howey* test to functionally similar tokens, reached opposite conclusions.
...
One year earlier, in *SEC v. LBRY*, Judge Paul Barbadoro took the opposite approach. Analyzing functionally similar tokens, he held that "all of LBRY's past, present, and future offers and sales" constituted investment contracts. Unlike *Ripple*, *LBRY* did not distinguish between sale methods. The court treated the token itself as the relevant unit of analysis.
...
Oranburg is not uncritical of this solution. CLARITY trades *Howey*'s doctrinal ambiguity for technical ambiguity. Courts must now consistently interpret whether networks have achieved "autonomous operation" and eliminated "concentrated control" across diverse blockchain architectures. If different courts diverge in interpreting these technical standards, they risk replicating the very fragmentation the Act was designed to eliminate.
...
CLARITY offers a principled resolution. But as Oranburg makes clear, the path from a good statute to good outcomes runs through institutional capacity -- the ability of courts, regulators, and market participants to apply new technical standards consistently and fairly. That capacity does not yet exist. Building it is the next challenge.
